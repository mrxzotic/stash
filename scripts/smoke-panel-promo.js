...
assert.match(promoSource, /stashLogoUrl/, "Founder popup should show the Stashed logo");
...
assert.match(promoSource, /xSocialIcon/, "Founder popup should use an X social icon");
