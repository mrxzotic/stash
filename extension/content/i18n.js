...
var TUCKIO_I18N_MESSAGE_ROWS = [
  ...
  ["Delete item?", "¿Eliminar artículo?", "Artikel löschen?", "Supprimer l’article ?", "Удалить товар?"],
  ...
  ["{item} will be removed from your saved items.", "{item} se eliminará de tus artículos guardados.", "{item} wird aus deinen gespeicherten Artikeln entfernt.", "{item} sera supprimé de vos articles enregistrés.", "{item} будет удалён из сохранённых товаров."],
